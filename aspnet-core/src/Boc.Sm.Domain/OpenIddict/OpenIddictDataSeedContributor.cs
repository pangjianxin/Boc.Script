...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("Sm") == null)
        {
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["Sm_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["Sm_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
                ...
                scopes: commonScopes,
                redirectUri: $"{consoleAndAngularClientRootUrl}/login/oidc/callback",
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["Sm_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["Sm_Swagger:RootUrl"]?.TrimEnd('/');
