...
import { useUpdateScriptForm } from '../hooks/update';
import { SubmitEventPromise } from 'vuetify';
import { mdiPower, mdiCheck } from '@mdi/js';

const themeStore = useThemeStore();

const { form, formLoading, formRef, formRules, formValid, submit, updateFormItems } = useUpdateScriptForm();
...
watch(() => props.modelValue, async (newVal) => {
    if (newVal) {
        await updateFormItems(props.id);
    }
});
