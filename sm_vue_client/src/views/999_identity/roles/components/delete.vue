...
import { VoloAbpIdentityIdentityRoleDto, SystemClient } from '@/openapi/system';
import { OpenAPI } from '@/openapi/system/core/OpenAPI';
import { PropType } from 'vue';
import { SubmitEventPromise } from 'vuetify';
import { mdiPower, mdiDelete } from '@mdi/js';
...
const props = defineProps({
    ...
    role: {
        type: Object as PropType<VoloAbpIdentityIdentityRoleDto>,
        required: false
    },
});
